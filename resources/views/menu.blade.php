  ...
  <![endif]-->
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="services-icon">
                            ...
                            <img class="shape-1" src="assets/images/rty.png" alt="shape">
                        </div>
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Go Food</a></h4>
                            <p class="text">Temukan list minuman favorit kamu dan makanan yang bisa bikin perut kamu kenyang disini.</p>
                            <a class="more" href="https://gofood.link/a/DkNpP9C">Learn More <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Grab Food</a></h4>
                            <p class="text">Temukan list minuman favorit kamu dan makanan yang bisa bikin perut kamu kenyang disini.</p>
    ...
    <section id="features" class="services-area pt-120">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1.4s">
                    <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1s">DAFTAR MENU</h3>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="about-image text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="100">
                            <img src="assets/images/az.jpeg" alt="services">
                        </div>
                    </div>
                </div>
    </section>
